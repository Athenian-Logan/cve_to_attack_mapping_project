...
def main():
    ...
    project_dir = 'scripts/supervised/datasets/enriched_simple_cwe_to_tactic/'
    config = Config()
    ...
    y_train_df = df_train.drop(df_train.columns[0:5], axis=1)

    f1_best_metrics = compute_metrics(BEST_PREDICTED, BEST_TRUE, f1_score, df_test.columns[5:], 14)

    print("Recall scores per class")
    recall_best_metrics = compute_metrics(BEST_PREDICTED, BEST_TRUE, recall_score, df_test.columns[5:], 14)

    print("Precision scores per class")
    precision_best_metrics = compute_metrics(BEST_PREDICTED, BEST_TRUE, precision_score, df_test.columns[5:], 14)

    print("Accuracy scores per class")
    acc_best_metrics = compute_metrics(BEST_PREDICTED, BEST_TRUE, accuracy_score, df_test.columns[5:], 14)

    print_F1_based_on_distribution(BEST_PREDICTED, BEST_TRUE, y_train_df,  df_test.columns[5:])
    ...
    f1_metrics = compute_metrics(BEST_PREDICTED, BEST_TRUE, f1_score, df_test.columns[5:], 14)

    print(f1_metrics)

    print("Recall scores")
    recall_metrics = compute_metrics(BEST_PREDICTED, BEST_TRUE, recall_score, df_test.columns[5:], 14)

    print("Precision scores")
    precision_best_metrics = compute_metrics(BEST_PREDICTED, BEST_TRUE, precision_score, df_test.columns[5:], 14)

    print("Accuracy scores")
    acc_metrics = compute_metrics(BEST_PREDICTED, BEST_TRUE, accuracy_score, df_test.columns[5:], 14)
