...
LR_model = pickle.load(open("SMET/main/LR_ATT&CK_model_V2.pkl", 'rb'))
emb_model = SentenceTransformer("basel/ATTACK-BERT")
id2mitre = funs.read_json_as_dict('SMET/main/id2mitre.json')
id2label = funs.read_json_as_dict('SMET/main/id2ATT&CK_V2.json')
