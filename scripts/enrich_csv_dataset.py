...
if "Text" in existing_columns:
    ...
    # Remove new columns from the existing column list if they were already added
    existing_columns = [col for col in existing_columns if col not in ["CWE Info", "CVSS Info", "CPE Info"]]
    reordered_columns = (
